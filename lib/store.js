...
var createStoreMultiplexer = exports.createStoreMultiplexer = function createStoreMultiplexer(storeMapping) {
  ...
  var mapReduceStores = function mapReduceStores(operation) {
    ...
    try {
      for (var _iterator4 = storeMap.entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
  ...
  var storesLiteral = storeMapping.reduce(function (prev, _ref2) {
...
var createActionMultiplexer = exports.createActionMultiplexer = function createActionMultiplexer(actionMapping) {
  ...
  var selectActionCreator = function selectActionCreator(actionName) {
    ...
    var _ref4$translatePayloa = _ref4.translatePayload;
    var translatePayload = _ref4$translatePayloa === undefined ? identityTranslator : _ref4$translatePayloa;
    var _ref4$translateMeta = _ref4.translateMeta;
    var translateMeta = _ref4$translateMeta === undefined ? identityTranslator : _ref4$translateMeta;
